...
urlpatterns = [
    ...
    path('FurnaceBaseTrends/', views.FurnaceBaseTrends, name='FurnaceBaseTrends'),
    path('FurnaceBaseTrendsData/', views.FurnaceBaseTrendsData, name='FurnaceBaseTrendsData'),
